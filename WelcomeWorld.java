...
=======
    ...
    Label employeeWageTitle = new Label("Hourly Wage",30);
    Label employeeWageLabel = new Label("$0/hr",36);
    Label utilitiesTitle = new Label("Hourly Utilities",30);
...
=======
    ...
    private void displayWage() {
        ...
        addObject(employeeWageLabel,getWidth()-100,175);
    }
    ...
    private void displayUtilities() {
        ...
        addObject(utilitiesLabel,getWidth()-100,275);
    }
    ...
    private void showMenu() {
        ...
        addObject(employeeWageTitle,getWidth()-100,125);
        addObject(employeeWageLabel,getWidth()-100,175);
        addObject(utilitiesTitle,getWidth()-100,225);
        addObject(utilitiesLabel,getWidth()-100,275);
